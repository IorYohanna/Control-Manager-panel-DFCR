  ...
  return (
    <>
      ...
      <div className="col-span-1 h-full relative group">
        <div className="h-full flex flex-col backdrop-blur-xl bg-[#f5ece3]/50 rounded-4xl p-6 lg:p-8 shadow-lg border border-white/50 hover:border-white/60 transition-all duration-500 hover:shadow-xl">
